...
public class ProductApplicationTests{
	...
	public void getSpecificProductTest() throws Exception{
		...
		Mockito.when(service.getSpecificProduct(1)).thenReturn(productDTO);
		assertEquals(service.getSpecificProduct(1), productDTO);	
	}
	...
	public void getSpecificProductTestInvalid() {
		...
		Mockito.when(service.getSpecificProduct(1)).thenReturn(productDTO);
		assertNotEquals(service.getSpecificProduct(1), null);
	}
}
